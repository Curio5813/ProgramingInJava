...
public class ImpostoDeRenda {
	...
	public static void main(String[] args) {
		...
		if(0 <= rendimentos && rendimentos <= 2000.00) {
			...
			System.out.printf("R$ %.2f", (rendimentos - 2000) * 0.08 );
		}
		else if(3000.01 <= rendimentos && rendimentos <= 4500.00) {
			System.out.printf("R$ %.2f",  (3000 - 2000 )* 0.08 + (rendimentos - 3000) * 0.18);
		}
		else if(rendimentos > 4500.00) {
			System.out.printf("R$ %.2f", (3000 - 2000) * 0.08 + (4500 - 3000) * 0.18 +(rendimentos - 4500) * 0.28);
		}
